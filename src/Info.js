    ...
    return (
        <Grid>
            <Row>
                ...
                <p>The Soda Club stocks different types of soft drinks, ice cream and chocolate bars. Items are purchased through the web interface. You deposit money either by MobilePay to {CONTACT_PHONE} or cash.</p>
            </Row>
        </Grid>
    );
  }
